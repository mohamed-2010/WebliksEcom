...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Free delivery after')}}</h5>
            </div>
            <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                  @csrf
                  <input type="hidden" name="type" value="free_delivery_after">
                  <div class="form-group row">
                      ...
                      <div class="col-md-7">
                          <label class="aiz-switch aiz-switch-success mb-0">
                              <input type="checkbox" name="free_delivery_after_enabled" @if(get_setting('free_delivery_after_enabled') == 1) checked @endif>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-7">
                          <input class="form-control" type="text" name="free_delivery_after" value="{{ get_setting('free_delivery_after') }}">
                      </div>
                  </div>
                  <div class="form-group mb-0 text-right">
                      <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
