            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Products Count')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="products_count">
                                <input type="text" name="products_count" class="form-control" value="{{ get_setting('products_count') }}">
                            </div>
                        </div>
                        <div class="form-group row">
