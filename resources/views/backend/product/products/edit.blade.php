        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            @if($product->category_add_on_ids != "")
                            <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="category_add_on_ids[]" id="category_add_on_ids" multiple>
                                ...
                                <option value="{{ $category_addon->id }}" @if(is_array(json_decode($product->category_add_on_ids)) && in_array($category_addon->id, json_decode($product->category_add_on_ids))) selected @endif
                                    >{{ $category_addon->name }}</option>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="accordion-container">
                            <div class="col-12 accordion">{{translate('Click to open variants table')}}</div>
                            <div class="panel">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="file-preview box sm" id="pdf-preview"></div>

                                @if($product->pdf)
                                    <a href="javascript:void(0)" onclick="openPdfPopup('{{ uploaded_asset($product->pdf) }}')" class="btn btn-primary mt-2">{{ translate('View PDF') }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="pdfModalLabel">{{ translate('PDF Specification') }}</h5>
