                        ...
                        <div class="d-flex border-bottom pb-3">
                            <div class="flex-grow-1">
                                <select name="user_id" class="form-control aiz-selectpicker pos-customer" data-live-search="true" onchange="getShippingAddress()">
                                    ...
                                    <option value="online">{{translate('Online order')}}</option>
                    ...
                    <div class="dropdown dropup m-1">
                        <div class="">
                            <div class="input-group d-flex justify-content-between">
                                    <input type="number" min="0" placeholder="Amount" name="discount" class="form-control col-4" value="{{ Session::get('pos.discount', 0) }}" required onchange="">
                                    <div class="input-group-append">
                                        <select class="form-control" name="discount_type" onchange="">
                                            <option value="flat">{{ translate('Flat') }}</option>
                                            <option value="percentage">{{ translate('Percentage') }}</option>
                                        </select>
                                    </div>
                                    <button class="btn btn-outline-dark btn-styled" type="button" onclick="setDiscount()">
                                        {{translate('Discount')}}
                                    </button>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-xl">
            <div class="modal-content" id="variants">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="oflinePayment()" class="btn btn-base-1 btn-warning">{{translate('Visa Payment')}}</button>
...
@section('script')
    <script type="text/javascript">
        ...
        function setDiscount(){
            ...
            $.post('{{ route('pos.setDiscount') }}',{_token:AIZ.data.csrf, discount:discount, discount_type:discount_type}, function(data){
                updateCart(data);
            });
        }
