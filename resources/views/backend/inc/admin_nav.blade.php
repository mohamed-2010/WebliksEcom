<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
                                            ...
                                            <div class="media-body">
                                                @if($notification->type == 'App\Notifications\OrderNotification')
                                                    <p class="mb-1 text-truncate-2">
                                                        ...
                                                        <a href="{{ route('all_orders.show', encrypt($notification->data['order_id'])) }}" class="text-reset fw-600">
            ...
            @endphp
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown " id="lang-chang">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon">
                            <img src="{{ static_asset('assets/img/flags/'.LaravelLocalization::getCurrentLocale().'.png') }}" height="11">
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-xs">
                        ...
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <li id="lang-chang" data-flag="{{LaravelLocalization::getLocalizedURL($localeCode, null, [], true)}}">
                                    <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="dropdown-item @if(LaravelLocalization::getCurrentLocale() == $localeCode) active @endif" data-flag="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        <img src="{{ static_asset('assets/img/placeholder.jpg') }}" data-src="{{ static_asset('assets/img/flags/'.$localeCode.'.png') }}" class="mr-1 lazyload" alt="{{ $properties['native'] }}" height="11">
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        ...
                        <a href="{{ route('logout')}}" class="dropdown-item d-none d-xl-block">
