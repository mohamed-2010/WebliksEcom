...
{{-- Branches --}}
                @can('branch_access')
                <li class="aiz-side-nav-item">
                    <a href="{{route('branches.index')}}" class="aiz-side-nav-link">
                        <i class="fa-solid fa-tree-city aiz-side-nav-icon"></i>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('view_product_attributes')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('attributes.index' ,['lang'=>env('DEFAULT_LANGUAGE')])}}" class="aiz-side-nav-link {{ areActiveRoutes(['attributes.index','attributes.create','attributes.edit','attributes.show','edit-attribute-value'.''])}}">
                ...
                @endif
                                ...
                                <!-- Category AddOns -->
                    <li class="aiz-side-nav-item">
                        <a href="{{route('category_addons.index')}}" class="aiz-side-nav-link">
                            <i class="las la-plus aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Category AddOns')}}</span>
                        </a>
                    </li>
                ...
                @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Sales')}} <span class="btn btn-primary m-1 p-1"> ({{ $all_orders_count }}) </span> </span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_all_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('all_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('All Orders')}} <span class="btn btn-primary m-1 p-1"> ({{ $all_orders_count }}) </span> </span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_inhouse_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('inhouse_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['inhouse_orders.index', 'inhouse_orders.show'])}}" >
                                        <span class="aiz-side-nav-text">{{translate('Inhouse orders')}} <span class="btn btn-primary m-1 p-1"> ({{ $in_house_orders_count }}) </span> </span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('view_seller_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('seller_orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Seller Orders')}} <span class="btn btn-primary m-1 p-1"> ({{ $seller_orders_count }}) </span> </span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('view_pickup_point_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('pick_up_point.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pick_up_point.index','pick_up_point.order_show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Pick-up Point Order')}} <span class="btn btn-primary m-1 p-1"> ({{ $pickup_point_orders_count }}) </span> </span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                <!-- Reports -->
                @canany(['in_house_product_sale_report','seller_products_sale_report','products_stock_report','product_wishlist_report','user_search_report','commission_history_report','wallet_transaction_report','sales_report'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('salesReport.index') }}" class="aiz-side-nav-link">
                ...
                @canany(['view_all_flash_deals','send_newsletter','send_bulk_sms','view_all_subscribers','view_all_coupons'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endif
                            <!-- admin.products.bulk-discount-update -->
                            <li class="aiz-side-nav-item">
                                <a href="{{route('products.bulk-discount-form')}}" class="aiz-side-nav-link {{ areActiveRoutes(['products.bulk-discount-form'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Discount') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('footer_setup')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('website.footer', ['lang'=>  \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()] ) }}" class="aiz-side-nav-link {{ areActiveRoutes(['website.footer'])}}">
                ...
                @canany(['general_settings','features_activation','language_setup','currency_setup','vat_&_tax_setup',
                        ...
                        'google_firebase_setting','google_merchant_setting','facebook_merchant_setting','shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                                ...
                                @endcan
                            @canany(['facebook_chat','facebook_comment','facebook_merchant_setting'])
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                        @can('facebook_merchant_setting')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('facebook-merchant.index') }}" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text">{{ translate('Facebook Commerce Manager') }}</span>
                                            </a>
                                        </li>
                                    @endcan
                                    </ul>
                            ...
                            @canany([/*'analytics_tools_configuration',*/'google_recaptcha_configuration','google_map_setting','google_firebase_setting', 'google_merchant_setting'])
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                        @can('google_merchant_setting')
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('google-merchant.index') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{ translate('Google Merchant Center') }}</span>
                                                </a>
                                            </li>
                                        @endcan
                                    </ul>
                            ...
                            @endcanany
                            @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers','shipment_configurations'])
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                        @can('shipment_configurations')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('shippment_method.index') }}" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text">{{translate('Shipment Configurations')}}</span>
                                            </a>
                                        </li>
                                        @endcan
                                    </ul>
            ...
            <!-- Support -->
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{route('admin.worktimes')}}" class="aiz-side-nav-link">
                        <i class="las la-calendar-times aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Working hours')}}</span>
