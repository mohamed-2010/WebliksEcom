                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="type" id="coupon_type" class="form-control aiz-selectpicker" onchange="coupon_form()" required>
                            ...
                            <option value="category_base" @if (old('type') == 'category_base') selected @endif>{{translate('For Categories')}}</option>
                            <option value="brand_base" @if (old('type') == 'brand_base') selected @endif>{{translate('For Brands')}}</option>
                        </select>
                    </div>
                </div>
