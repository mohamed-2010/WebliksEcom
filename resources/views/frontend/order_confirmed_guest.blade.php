            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    <div class="card shadow-sm border-0 rounded">
                        <div class="card-body">
                            @php
                                $user = \App\Models\Guest::where('id', $order->guest_id)->first();
                                //return dd($first_order);
                            @endphp
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><address>
                                                        ...
                                                        <strong class="text-main">
                                                            {{ translate('Phone') }}:
                                                        </strong> {{ $user->phone ?? "" }}, <strong class="text-main">
                                                            {{ $order->shipping_address != null ? translate('Type') : translate('Pickup Point')}}:
                                                        </strong> 
                                                        @if($order->shipping_address != 'null')
                                                            {{ json_decode($order->shipping_address)->address_type ?? '' }} <br>
                                                            <strong class="text-main">
                                                                {{ translate('State') }}:
                                                            ...
                                                            </strong> {{ json_decode($order->shipping_address)->building_name ?? "" }}, <strong class="text-main">
                                                                {{ translate('Building Number') }}:
                                                            </strong> {{ json_decode($order->shipping_address)->building_number ?? "" }} <br>
                                                            <strong class="text-main">
                                                                {{ translate('Floor') }}:
