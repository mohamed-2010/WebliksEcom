<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
            ...
            <h4 class="h5 fs-16 mb-1 fw-600" style="color: black !important;">{{ Auth::user()->name }}</h4>
            @if (Auth::user()->phone != null)
                <div class="text-truncate opacity-60" style="color: black;">{{ Auth::user()->phone }}</div>
            @else
                <div class="text-truncate opacity-60" style="color: black;">{{ Auth::user()->email }}</div>
            @endif
        </div>
