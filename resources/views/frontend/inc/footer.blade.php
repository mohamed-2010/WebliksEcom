        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div class="my-3">
                        {!! get_setting('about_us_description',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()) !!}
                    </div>
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="pad-hor" role="form" method="POST" action="{{ route('subscribers.store') }}" id="subscribe-form">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="g-recaptcha" data-sitekey="{{ env('CAPTCHA_KEY') }}" data-callback="enableSubscribe"></div>                                @if ($errors->has('g-recaptcha-response'))
                            ...
                            @endif
                            @if(get_setting('google_recaptcha') == 1)
                            <button type="submit" class="btn btn-primary" id="subscribe-btn" disabled>
                                {{ translate('Subscribe') }}
                            </button>
                            @else
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           ...
                           <span class="d-block opacity-70">{{ get_setting('contact_address',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()) }}</span>
                        </li>
                        <li class="mb-2">
            ...
            @if ( get_setting('widget_one_labels',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()) !=  null && count(json_decode( get_setting('widget_one_labels',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()), true)) > 0 )
                <div class="col-lg-2 col-md-4">
                    <div class="text-center text-md-left mt-4">
                        <h4 class="fs-13 text-uppercase fw-600 border-bottom border-gray-900 pb-2 mb-4">
                            {{ get_setting('widget_one',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()) }}
                        </h4>
                        <ul class="list-unstyled">
                            @if ( get_setting('widget_one_labels',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()) !=  null )
                                @foreach (json_decode( get_setting('widget_one_labels',null,\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()), true) as $key => $value)
                                <li class="mb-2">
        ...
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="text-center text-md-left" current-verison="{{get_setting("current_version")}}">
                    {!! get_setting('frontend_copyright_text',$lang, null) !!}
                </div>
            </div>
            <div class="col-lg-4">
                    ...
                    <ul class="list-inline mb-0">
                        @if ( get_setting('payment_method_images') !=  null )
                            @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                <li class="list-inline-item">
                                    <img src="{{ uploaded_asset($value) }}" height="30" class="mw-100" style="max-height: 30px">
                                </li>
                            @endforeach
                        @endif
                    </ul>
...
<script>
    $(document).ready(function(){
        $("#subscribe-form").on("submit", function(evt) {
