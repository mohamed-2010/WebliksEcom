...
@section('panel_content')
    ...
    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data" onsubmit="return validatePassword()">
        @csrf
        <!-- Basic Info-->
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="password" id="new_password" class="form-control" name="new_password" onkeyup="checkPasswordStrength()">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="password" id="confirm_password" class="form-control" name="confirm_password" onkeyup="validateConfirmPassword()">
