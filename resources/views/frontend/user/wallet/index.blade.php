                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    <select class="form-control selectpicker" data-minimum-results-for-search="Infinity"
                                        ...
                                        <option value="RechargeBookeeypay" >{{ translate('Knet') }}</option>
                                        <option value="bookeeypay_credit" >{{ translate('Visa / Master') }}</option>

                                        @endif
                                        @if(get_setting('upayment') == 1)
                                        @if(get_setting('upayment_kenet') == 1)
                                        <option value="Rechargeupay" >{{ translate('Online payment') }}</option>
                                        @endif
                                        @endif
