                    ...
                    <div class="row aiz-steps arrow-divider">
                        <div class="col active">
                            <div class="text-center text-primary">
                                ...
                                <h3 class="fs-14 fw-600 d-none d-lg-block">{{ $delivery_info_step_active == true ? translate('1. My Cart') : translate('1. My Cart') }}</h3>
                            </div>
                        </div>
                        <div class="col">
                            <div class="text-center">
                                <i class="la-3x mb-2 opacity-50 las la-map"></i>
                                <h3 class="fs-14 fw-600 d-none d-lg-block opacity-50">{{ $delivery_info_step_active == true ? translate('2. Shipping info') : translate('2. Shipping info') }}
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                                        ...
                                        @php
                                            ...
                                            if($cartItem['addons'] != null || $cartItem['addons'] != "") {
                                                foreach(json_decode($cartItem['addons']) as $addon){
                                                    $total += $addon->price*(int)$addon->quantity;
                                        ...
                                        <li class="list-group-item px-0 px-lg-3">
                                            <div class="row gutters-5">
                                                <div class="col-lg-5 d-flex">
                                                    ...
                                                    <div class="row align-items-center row-cols-1 text-center">
                                                        <div class="col-12">
                                                        ...
                                                        @foreach(json_decode($cartItem['addons']) as $addon)
                                                            ...
                                                            @endphp
                                                            @if($addon->quantity > 0)
                                                                <span class="fs-14 opacity-60">{{ $addOn->getTranslation('name') }} : {{ single_price($addon->price) }}</span>
                                                            @endif
                                                        @endforeach
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                                    ...
                                                    <span
                                                        class="fw-600 fs-16 text-primary">{{ single_price((cart_product_price($cartItem, $product, false) * $cartItem['quantity']) + $addons_total) }}</span>
                                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-center text-md-right">
                                    @if($order_limitation ==1 || $time == 1)
                                        @if($order_limitation ==1)
                                            <h5 class="fw-400 fs-15 text-left">{{translate('The maximum number of orders has been reached today. You can order later')}}</h5>
                                        @endif
                                        @if($time == 1 )
                                            <h5 class="fw-400 fs-15 text-left">{{translate('You order outside official hours, order later')}}</h5>
                                        @endif
                                    @else

                                        @if (Auth::check())
                                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-primary fw-600">
                                                {{ translate('continue_to_shipping') }}
                                            </a>
                                        @else
                                        <!-- Guest Checkout -->
                                            <a href="{{ route('checkout.guest') }}" class="btn btn-primary fw-600">
                                                {{ translate('Continue As guest')}}
                                            </a>
                                            <button class="btn btn-primary fw-600"
                                                    onclick="showCheckoutModal()">{{ translate('Continue to login') }}</button>
                                        @endif
        ...
        <div class="modal-dialog modal-dialog-zoom">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST" id="loginForm">
                            @csrf
