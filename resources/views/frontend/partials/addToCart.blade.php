    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="col flex-col-reverse">
                ...
                <div class="col-auto">
                    <div class="aiz-carousel carousel-thumb product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='false' data-focus-select='true' data-arrows="true">
                        @foreach ($photos as $key => $photo)
                        <div class="carousel-box c-pointer border p-1 rounded" data-variation="{{ $key == 0 ? "" : $stock->variant }}">
                            <img
