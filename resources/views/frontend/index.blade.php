                                    ...
                                    @if ($category != null)
                                        <div class="carousel-box">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="fs-15">
                                                    <a href="{{ route('products.category', $category->slug) }}" class="fw-700 text-primary">{{  $category->getTranslation('name')  }}</a>
                                                </div>
                                                </div>
                                                </div>
                                        </div>
...
<!--Ahmed Mousa-->
    <div id="section_newest" style="display: none;">
    ...
    @if(!count($home_categories) > 0 || count($home_categories) <= 3)
    {{-- Banner Section 2 --}}
                                         ...
                                         <div class="carousel-box">
                                            ...
                                            <div class="position-relative">
                                                <a href="{{ route('products.brand', $brand->slug) }}" class="d-block">
                                                    <img
                                                        class="img-fit lazyload mx-auto h-115px h-md-115px"
                                                        src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                ...
                                                <div class="p-md-3 p-2 text-center">
                                                <div class="fs-15">
                                                    <a href="{{ route('products.brand', $brand->slug) }}" class="fw-700 text-primary">{{  $brand->getTranslation('name') }}</a>
                                                </div>
                                                </div>
                                                </div>
                                        </div>
