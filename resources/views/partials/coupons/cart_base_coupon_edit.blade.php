...
<div class="form-group row">
  ...
  <div class="col-lg-9">
     <input type="number" lang="en" min="0" step="0.01" name="min_buy" class="form-control" value="{{ isset($coupon_det->min_buy) ? $coupon_det->min_buy : '' }}" required>
  </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
  ...
  <div class="col-lg-9">
     <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Maximum Discount Amount')}}" name="max_discount" class="form-control" value="{{ isset($coupon_det->max_discount) ? $coupon_det->max_discount : '' }}" required>
  </div>
</div>
