...
(function ($) {
    ...
    AIZ.data = {
        ...
        appUrl: $('meta[name="app-url"]').attr("content").replace("http://", "https://"),
        ...
        getAllUploads: function (url, search_key = null, sort_key = null) {
            ...
            $.get(url, params, function (data, status) {
                ...
                if (data.next_page_url != null) {
                    AIZ.uploader.data.next_page_url = data.next_page_url.replace("http://", "https://");
            ...
            $(".aiz-text-editor").each(function (el) {
                ...
                buttons = !buttons
                    ? [
                          ...
                          ["view", ["fullscreen", "undo", "redo", "codeview"]], // Added 'codeview' here
                      ]
                    : buttons;
                ...
                // On text change
                $this.on("summernote.change", function (e) {
                    var divs = document.querySelectorAll(".note-editable span");
                    divs.forEach((div) => {
                ...
                $this
                    .summernote("module", "videoDialog")
                    .createVideoNode = function (url) {
                    var wrap = $(
                ...
                uppy.use(Uppy.Dashboard, {
                    ...
                    locale: {
                        strings: {
                            ...
                            dropPaste: AIZ.local.drop_files_here_paste_or+' %{browse} Maximum Upload File Size: 5 MB',
