...
class UpayCreditController extends Controller {
    public function pay(){
        if(Auth::user() != null) {
        ...
        $url = env('UPAYMENT_URL');
            ...
            $fields = array(
                ...
                "customer" => array(
                    "uniqueId" => Auth::user() != null ? Auth::user()->id : "0",
                ...
                "returnUrl" => route('upay.success'),
                "cancelUrl" => route('upay.fail'),
                "notificationUrl" => route('upay.success'),
                "customerExtraData" => ""
            );
    ...
    public function success(Request $request) {
        ...
        if(Auth::user() == null) {
            ...
            $request['payment_option'] = "upay_credit";
