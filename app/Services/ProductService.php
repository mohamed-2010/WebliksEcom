...
class ProductService
{
    public function store(array $data)
    {
        ...
        if ($collection['meta_img'] == null) {
            if($collection['thumbnail_img'] != null) {
                $collection['meta_img'] = $collection['thumbnail_img'];
            }else{
                // meta image will take first image of gallery
                $collection['meta_img'] = explode(',', $collection['photos'])[0];
            }
        }
        ...
        $category_add_on_ids = $collection['category_add_on_ids'];
    ...
    public function update(array $data, Product $product)
    {
        ...
        if ($collection->has('category_add_on_ids')) {
            $category_add_on_ids = $collection['category_add_on_ids'];
        }else{
            $category_add_on_ids = [];
        }
