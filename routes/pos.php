...
Route::controller(PosController::class)->group(function () {
	...
	Route::post('/updateAddon', 'updateAddon')->name('pos.updateAddon');
	Route::post('/removeAddon', 'removeAddon')->name('pos.removeAddon');

	Route::get('/get-invoice-details', 'getInvoiceDetails')->name('pos.getInvoiceDetails');
});
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::controller(PosController::class)->group(function () {
        ...
        Route::post('/pos/update-settings', [PosController::class, 'updateSettings'])->name('pos.update_settings');
