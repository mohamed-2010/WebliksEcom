...
use App\Http\Controllers\HeaderLinkAjaxController;
...
use App\Http\Controllers\CategoryAddOnController;
use App\Http\Controllers\ProductAddOnController;
use Mcamara\LaravelLocalization\Facades\LaravelLocalization;
use App\Http\Controllers\HomeNavbarTranslationController;
...
Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::post('/header-links/save', [HeaderLinkAjaxController::class, 'saveLink'])
         ->name('header_links.save');
        Route::delete('/header-links/{id}', [HeaderLinkAjaxController::class, 'deleteLink'])
            ->name('header_links.delete');
        Route::get('/header-links/{id}', [HeaderLinkAjaxController::class, 'show'])
            ->name('header_links.show');

        Route::post('/get_products_by_category_brand', [AdminController::class, 'get_products_by_category_brand'])->name('get_products_by_category_brand');
        //Work Times dashboard
        Route::get('/worktimes', [AdminController::class, 'worktimes'])->name('admin.worktimes');
        Route::post('/worktimesupdate', [AdminController::class, 'worktimesupdate'])->name('admin.worktimesupdate');
        Route::post('/home-navbar/save', [HomeNavbarTranslationController::class, 'store'])->name('home_navbar.store');
        Route::post('/delete-navbar/{id}', [HomeNavbarTranslationController::class, 'destroy'])->name('navbar.destroy');

        //Club Points
        Route::post('/club_point/get_filter_form', [ClubPointController::class, 'get_filter_form'])->name('admin.club_point.get_filter_form');
        Route::post('/club_point/set_points_for_selected_categories_brands', [ClubPointController::class, 'set_points_for_selected_categories_brands'])->name('admin.club_point.set_points_for_selected_categories_brands');

        //filter dashboard
        Route::get('/filter_dashboard', [AdminController::class, 'filter_dashboard'])->name('admin.filter_dashboard');
        //branch
        Route::resource('branches', BranchController::class);
        Route::controller(BranchController::class)->group(function () {
            Route::get('/branches/{id}/edit', 'edit')->name('branches.edit');
            Route::get('/branches/destroy/{id}', 'destroy')->name('branches.destroy');
            Route::get('/branches/cities/{id}', 'manage_cities')->name('branches.control_branch_cities');
            //add_city
            Route::post('/branches/add_city/{id}', 'add_city')->name('branches.add_city');
        });
        ...
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::post('/products/store-product', 'store_product')->name('products.store_product');
        });

            //Category Addons
        Route::controller( CategoryAddOnController::class)->group(function () {
            Route::get('/category_addons', 'index')->name('category_addons.index');
            Route::get('/category_addons/create', 'create')->name('category_addons.create');
            Route::post('/category_addons/store', 'store')->name('category_addons.store');
            Route::get('/category_addons/{id}/edit', 'edit')->name('category_addons.edit');
            Route::post('/category_addons/{id}/update', 'update')->name('category_addons.update');
            Route::get('/category_addons/{id}/destroy', 'destroy')->name('category_addons.destroy');
        });

        //Product Addons
        Route::controller(ProductAddOnController::class)->group(function () {
            Route::get('/product_addons/{category_id}', 'index')->name('product_addon.index');
            Route::get('/product_addons/{category_id}/create', 'create')->name('product_addon.create');
            Route::post('/product_addons/{category_id}/store', 'store')->name('product_addon.store');
            Route::get('/product_addons/{category_id}/{id}/edit', 'edit')->name('product_addon.edit');
            Route::post('/product_addons/{category_id}/{id}/update', 'update')->name('product_addon.update');
            Route::get('/product_addons/{category_id}/{id}/destroy', 'destroy')->name('product_addon.destroy');
        });
        ...
        Route::controller(ProductBulkUploadController::class)->group(function () {
            //Product Export
            Route::get('/product-bulk-export/index', 'indexExport')->name('product_bulk_export.index');
            Route::get('/product-bulk-export', 'export')->name('product_bulk_export.export');
            Route::get('/get-subcategories', 'getSubcategories')->name('get_subcategories');
        ...
        Route::controller(BusinessSettingsController::class)->group(function () {
            Route::get('/business-settings/ga4/update', 'ga4_update')->name('ga4.update');
            ...
            Route::get('/shippment-method', 'shippment_method')->name('shippment_method.index');
            ...
            Route::get('/google-merchant', 'google_merchant')->name('google-merchant.index');
            Route::post('/google-merchant/update', 'google_merchant_update')->name('google-merchant.update');
            Route::get('/facebook-merchant', 'facebook_merchant')->name('facebook-merchant.index');
            Route::post('/facebook-merchant/update', 'facebook_merchant_update')->name('facebook-merchant.update');
            ...
            Route::post('/shippment_method_update', 'shippment_method_update')->name('shippment_method.update');
        ...
        Route::get('/marketing/bulk-discount', [ProductController::class, 'bulkDiscountForm'])->name('products.bulk-discount-form');
        Route::get('/marketing/bulk-discount-edit/{id}', [ProductController::class, 'bulkDiscountFormEdit'])->name('products.bulk-discount-form-edit');
        Route::post('/marketing/bulk-discount-update/{id}', [ProductController::class, 'bulkDiscountFormNewUpdate'])->name('products.bulk-discount-form-new-update');
        Route::post('/marketing/bulk-discount-delete/{id}', [ProductController::class, 'bulkDiscountFormDelete'])->name('products.bulk-discount-form-delete');
        Route::post('/products/bulk-discount', [ProductController::class, 'bulkDiscountUpdate'])->name('products.bulk-discount-update');
        ...
        Route::controller(OrderController::class)->group(function () {
            ...
            Route::get('/item/destroy/{id}/{order}', 'destroy_item')->name('item.destroy');
            Route::get('/item/add/{id}/{product}/{order}', 'add_item_order')->name('item.add.order');

            Route::get('/ajax-autocomplete-search', 'selectSearch')->name('ajax-autocomplete-search');
            Route::get('/select-product-size', 'selectProductSize')->name('selectProductSize');
            ...
            Route::post('/orders/update_shipping_company', 'update_shipping_company')->name('orders.update_shipping_company');
        ...
        Route::controller(ReportController::class)->group(function () {
            ...
            Route::get('/salesReport', 'salesReport')->name('salesReport.index');
            Route::get('/export-sales-report', 'salesReportExport')->name('export-sales-report');
        });
